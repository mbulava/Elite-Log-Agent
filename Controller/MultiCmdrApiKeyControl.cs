//Mbulava - Need to move this to a library more geared toward UI, so that we don't bind to a a project type...
...
//    using DW.ELA.Interfaces;//    using DW.ELA.Interfaces.Settings;
//    using MoreLinq;
//    using NLog;
